...
| 12 | Clean Up Generated Code & Docs | Low | ✅ Implemented | v0.3.7 | Automated `api/thing.json` generation natively inside the `buf` pipeline (no more manual Swagger UI exports) & Complete refactoring to replace OpenAPI-generated types with Protobuf types. |
