...
func (w *ServerInterfaceWrapper) Delete(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "thingId", ctx.Param("thingId"), &thingId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) TypeThingDelete(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "typeThingId", ctx.Param("typeThingId"), &typeThingId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/thing/geojson", wrapper.GeoJson)
