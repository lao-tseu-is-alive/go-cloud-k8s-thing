...
CREATE SCHEMA go_thing;
CREATE TYPE thing_status_type AS ENUM (
    'Planifié', -- This state refers to something that is in the early stages of development, where the design and construction plans have been finalized, but physical construction has not yet begun.
    'En Construction', -- Something is in the process of being built.
    'Utilisé', -- The thing is now being utilized for its intended purpose.
...
-- version : 0.0.4
*/
CREATE TABLE IF NOT EXISTS go_thing.thing
(
    ...
    name               text    not null constraint go_thing_unique_name	unique
...
--
CREATE TABLE IF NOT EXISTS go_thing.type_thing
(
    id                 serial
