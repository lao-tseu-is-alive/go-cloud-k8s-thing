...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    _delete: async (thingId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/thing/{thingId}`.replace(`{${"thingId"}}`, encodeURIComponent(String(thingId)))
    ...
    create: async (body: Thing, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      if (localVarRequestOptions.headers !== undefined) {
        needsSerialization =
    ...
    listByExternalId: async (
      ...
      if (externalId === null || externalId === undefined) {
        throw new RequiredError(
          "externalId",
          "Required parameter externalId was null or undefined when calling listByExternalId."
        )
      }
      const localVarPath = `/thing/by-external-id/{externalId}`.replace(
        `{${"externalId"}}`,
    ...
    typeThingDelete: async (typeThingId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      if (typeThingId === null || typeThingId === undefined) {
        throw new RequiredError(
          "typeThingId",
          "Required parameter typeThingId was null or undefined when calling typeThingDelete."
        )
      }
      const localVarPath = `/types/{typeThingId}`.replace(`{${"typeThingId"}}`, encodeURIComponent(String(typeThingId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, "https://example.com")
      let baseOptions
      if (configuration) {
    ...
    typeThingGet: async (typeThingId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      if (typeThingId === null || typeThingId === undefined) {
        throw new RequiredError(
          "typeThingId",
          "Required parameter typeThingId was null or undefined when calling typeThingGet."
        )
      }
      const localVarPath = `/types/{typeThingId}`.replace(`{${"typeThingId"}}`, encodeURIComponent(String(typeThingId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    typeThingUpdateForm: async (
      ...
      if (typeThingId === null || typeThingId === undefined) {
        throw new RequiredError(
          "typeThingId",
          "Required parameter typeThingId was null or undefined when calling typeThingUpdateForm."
        )
      }
      const localVarPath = `/types/{typeThingId}`.replace(`{${"typeThingId"}}`, encodeURIComponent(String(typeThingId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DefaultApiFp = function (configuration?: Configuration) {
  return {
    ...
    async count(
      ...
      validated?: boolean,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<number>>> {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).count(
        keywords,
        type,
        createdBy,
        inactivated,
    ...
    async create(
      body: Thing,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Thing>>> {
    ...
    async list(
      ...
      offset?: number,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<ThingList>>>> {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).list(
        type,
        createdBy,
        inactivated,
        validated,
    ...
    async listByExternalId(
      ...
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).listByExternalId(
        externalId,
        limit,
        offset,
        options
    ...
    async search(
      ...
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).search(
        keywords,
        type,
        createdBy,
        inactivated,
     ...
     * @throws {RequiredError}
     */
    async typeThingCount(
      keywords?: string,
      createdBy?: number,
      inactivated?: boolean,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<number>>> {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).typeThingCount(
        keywords,
        createdBy,
        inactivated,
        options
     ...
     * @throws {RequiredError}
     */
    async typeThingCreate(
      body: TypeThing,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<TypeThing>>> {
    ...
    async typeThingList(
      ...
      offset?: number,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<TypeThingList>>>> {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).typeThingList(
        keywords,
        createdBy,
        externalId,
        inactivated,
    ...
    async typeThingUpdateForm(
      ...
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).typeThingUpdateForm(
        typeThingId,
        id,
        name,
        description,
    ...
    async updateForm(
      ...
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).updateForm(
        thingId,
        id,
        typeId,
        name,
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  return {
    ...
    async count(
      ...
      return DefaultApiFp(configuration)
        .count(keywords, type, createdBy, inactivated, validated, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Creates a new thing
    ...
    async list(
      ...
      offset?: number,
      options?: AxiosRequestConfig
    ): Promise<AxiosResponse<Array<ThingList>>> {
      return DefaultApiFp(configuration)
        .list(type, createdBy, inactivated, validated, limit, offset, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns the things in an array
    ...
    async listByExternalId(
      ...
      return DefaultApiFp(configuration)
        .listByExternalId(externalId, limit, offset, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns the thing in an array
    ...
    async search(
      ...
      return DefaultApiFp(configuration)
        .search(keywords, type, createdBy, inactivated, validated, limit, offset, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns the number of TypeThings found after filtering with passed criterias
    ...
    async typeThingCount(
      ...
      return DefaultApiFp(configuration)
        .typeThingCount(keywords, createdBy, inactivated, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Creates a new group
    ...
    async typeThingDelete(typeThingId: number, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
      return DefaultApiFp(configuration)
        .typeThingDelete(typeThingId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Retrieve a specific typeThing
    ...
    async typeThingGet(typeThingId: number, options?: AxiosRequestConfig): Promise<AxiosResponse<TypeThing>> {
      return DefaultApiFp(configuration)
        .typeThingGet(typeThingId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns the types in an array
    ...
    async typeThingList(
      ...
      offset?: number,
      options?: AxiosRequestConfig
    ): Promise<AxiosResponse<Array<TypeThingList>>> {
      return DefaultApiFp(configuration)
        .typeThingList(keywords, createdBy, externalId, inactivated, limit, offset, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Updates the information related to a typeThing
    ...
    async typeThingUpdateForm(
      ...
      moreDataSchema?: any,
      options?: AxiosRequestConfig
    ): Promise<AxiosResponse<TypeThing>> {
      return DefaultApiFp(configuration)
        .typeThingUpdateForm(
          typeThingId,
          id,
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public async typeThingUpdateForm(
    typeThingId: number,
    id?: number,
    name?: string,
    description?: string,
