          ...
          >
            <template v-slot:top>
              <v-toolbar
                flat
              >
                <v-toolbar-title>My CRUD soon with the Thing stuff...</v-toolbar-title>
                <v-divider
                  class="mx-4"
                  inset
                  vertical
...
const desserts: iDessert[] = reactive([]);
...
const editItem = (item: iDessert) => {
  editedIndex.value = desserts.indexOf(item)
  editedItem.value = Object.assign({}, item)
  dialog.value = true
}

const deleteItem = (item: iDessert) => {
  editedIndex.value = desserts.indexOf(item)
  editedItem.value = Object.assign({}, item)
